...
//  Readyt
//
//  Created by Raul Martinez Padilla on 02/09/2018.
//  Copyright © 2018 Raul Martinez Padilla. All rights reserved.
//

import UIKit

class BookListPresenter: Presenter {
  ...
  let collectionView: UICollectionView = {
    ...
    bookList.register(OwnBookCell.self, forCellWithReuseIdentifier: "OwnBookCell")
  ...
  let minusButton = UIBarButtonItem(image: UIImage(named: "icons8-phonelink_setup"),
                                    style: .plain,
                                    target: nil,
                                    action: nil)
  ...
  override func setupViews() {
    ...
    viewController.navigationItem.title = "Book List"
    viewController.navigationItem.rightBarButtonItem = addButton
    viewController.navigationItem.leftBarButtonItem = minusButton
